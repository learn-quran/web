...
import '../Assets/StyleSheets/PrivacyPolicy.scss';

const PrivacyPolicy = ({ t }) => (
  <div className={`privacy-content en`}>
    <h1>Privacy Policy</h1>
    <p>
      Mohammad Shbool built the Learn Quran app as an Open Source app. This
      SERVICE is provided by Mohammad Shbool at no cost and is intended for use
      as is.
    </p>
    <p>
    ...
    <p>
      ...
      Terms and Conditions, which is accessible at Learn Quran unless otherwise
    ...
    <p>
      ...
      not limited to email, username. The information that I request will be
    ...
    <p>
      ...
      <a href="mailto:contactus.learnquran@gmail.com">
        contactus.learnquran@gmail.com
      </a>
    </p>
    <p>
      <em>
        This Privacy Policy was originally generated by&nbsp;
        <a href="https://www.privacypolicytemplate.net/">
          www.spanprivacypolicytemplate.net
        </a>
      </em>
    </p>
  </div>
